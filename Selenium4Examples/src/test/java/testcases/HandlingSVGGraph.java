...
public class HandlingSVGGraph {
	...
	public static void main(String[] args) throws InterruptedException {
		 ...
		 * ChromeDriver(); driver.get("https://www.covid19india.org/");
		 * driver.manage().window().maximize();
		 * driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
		 * 
		 * driver.findElement(By.xpath(
		 * "//*[@id=\"root\"]/div/div[3]/div[1]/div[4]/div[2]/div/div[9]/div[1]/div[1]")
		 * ).click(); Thread.sleep(3000); List<WebElement> graphPoints =
		 * driver.findElements(By.
		 * xpath("(//*[name()='svg'][@preserveAspectRatio='xMidYMid meet'])[6]//*[name()='circle' and contains(@class,'condensed')]"
		...
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("//div[contains(text(),'Delhi')]")))
				.click();
